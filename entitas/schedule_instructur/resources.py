...
class ScheduleInstructurWithIdResource:
    def on_get(self, req, resp, schedule_instructur_id: int):
        resouce_response_api(resp=resp, data=services.find_schedule_user_db_by_id(id=int(schedule_instructur_id)))
    ...
    def on_delete(self, req, resp, schedule_instructur_id: int):
        resouce_response_api(resp=resp, data=services.delete_schedule_user_by_id(id=int(schedule_instructur_id)))
...
class ScheduleInstructurByIdWithScheduleIdResource:
    ...
    def on_put(self, req, resp, schedule_id: int, user_id: int):
        ...
        resouce_response_api(resp=resp,
                             data=services.update_schedule_user_by_schedule_id(schedule_id=schedule_id, user_id=user_id, json_object=body))
