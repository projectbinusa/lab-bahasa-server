...
def admin_routes(api):
    ...
    api.add_route("/api/admin/schedule/{schedule_id}/instructur/{schedule_user_id}", AdminScheduleUserWithIdFeedbackResource())
    api.add_route("/api/admin/schedule/{schedule_id}/instructur", ScheduleUserWithIdFeedbackResource())
