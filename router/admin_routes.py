...
def admin_routes(api):
    ...
    api.add_route("/api/admin/schedule/{schedule_id}/instructur/{instructur_id}", ScheduleUserByIdWithScheduleIdResource())
    api.add_route("/api/admin/schedule/{schedule_id}/instructur", ScheduleUserByScheduleResource())
