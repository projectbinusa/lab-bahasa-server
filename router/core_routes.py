...
def core_routes(api):
    ...
    api.add_route('/api/chat/class_id/{class_id}', ChatResource())
    api.add_route('/api/chat/{chat_id}/class_id/{class_id}', ChatWithIdResource())
    ...
    api.add_route('/api/group/{group_id}/class_id/{class_id}', GroupWithIdResources())
    api.add_route('/api/anggota_group/{group_id}/class_id/{class_id}', AnggotaGroupResources())
    api.add_route('/api/delete_anggota_group/{anggota_group_id}/class_id/{class_id}', AnggotaGroupWithIdResources())
