...
def core_routes(api):
    ...
    api.add_route('/api/chats', ChatResource())
    api.add_route('/api/chtas', MessageChatResource())
    api.add_route('/users/{user_id}/chats', UserChatResource())
    api.add_route('/api/messages/{chat_id}', MessageChatResource())
